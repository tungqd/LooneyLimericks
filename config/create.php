<?php
	...
	$query .= "CREATE TABLE Poem (ID INT not null,title VARCHAR(30) not null,author VARCHAR(30) not null,content VARCHAR(200) not null,
        timeSelected TIME,PRIMARY KEY(ID));";
    $query .= "DROP TABLE IF EXISTS Rating;";
    $query .= "CREATE TABLE Rating (ID INT not null, pID INT not null, rating INT not null, PRIMARY KEY(ID),
